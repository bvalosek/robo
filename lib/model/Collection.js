...
.class('Collection') .uses(WithObservableProperties) .implements(IList) .define({
    ...
    __fluent__add: function(obj)
    {
        ...
        // Proxy events from added object
    ...
    // Remove all items, triggers a clear event. does NOT triggere a remove
    // event for all objects
    ...
    {
        this.removeAt(this._items.indexOf(obj));
        return this;
    },
