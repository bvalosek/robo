...
.class('ObservableObject') .uses(WithObservableProperties, require('../util/WithEventLogging')) .define({

    __constructor__: function(_props)
    {
        this.initEvents();

        Object.defineProperty(this, '__frames', {
            configurable: true, enumberable: false,
            writable: false, value: []
        });

        Object.defineProperty(this, '__deps', {
            configurable: true, enumberable: false,
            writable: false, value: {}
        });
